...
buildIOS()
{
	...
	if [[ "${ARCH}" == *"arm64"* || "${ARCH}" == "arm64e" ]]; then
		./configure --disable-shared --enable-static --host="arm-apple-darwin" --enable-examples --enable-ipv6 --enable-ecc --enable-aesgcm --enable-hkdf --enable-alpn --enable-sni --enable-oldtls  --enable-opensslextra --enable-ecccustcurves  --enable-lighty --enable-session-ticket
	else

		./configure --disable-shared --enable-static --host="${ARCH}-apple-darwin" --enable-examples --enable-ipv6 --enable-ecc --enable-aesgcm --enable-hkdf --enable-alpn --enable-sni --enable-oldtls  --enable-opensslextra --enable-ecccustcurves  --enable-lighty --enable-session-ticket
